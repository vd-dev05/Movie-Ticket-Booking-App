...
import { userSchemaSignUp } from "@/validations/Yup/useYupForm";
...
import { v4 } from 'uuid'
import OTPVery from "@/components/common/auth/otp/OTPVery";
...
const SignUp = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (value) => {
            ...
            try {
                const reponse = await UserController.checkValidPhone(value)
                if (reponse.status === 403) {
                    if (isMounted) showErrorToast(reponse.data || "Phone number already registered!");
