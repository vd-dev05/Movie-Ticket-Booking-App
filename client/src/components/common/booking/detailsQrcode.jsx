                    ...
                    <div className={`${themeUniver}  iphone-12-pro-max:flex flex flex-col h-full min-w-full  font-movie px-5 `}>
                        <div className="flex items-center justify-between py-10">
                            <div className="">
                                <Link
                                    to={'/ticket'}
                                    className={`${textClasses} hover:${textClasses}`}
                                >
                                   <FaChevronLeft  />
                                </Link>
                            </div>
                            ...
                            <div className="w-full p-10">
                                ...
                                <div className="my-10 flex gap-10 flex-col">
                                    <div className="flex justify-between  ">
                                        <div >
                                            <p className={textClasses}>Full name</p>
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span className="font-bold">
                                                ...
                                                {dataMap?.book?.event?.start} - {dataMap?.book?.event?.end}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="flex justify-between  ">
                                    ...
                                    <div className="drop-shadow-2xl w-full text-center">
                                        <h2 className="text-center font-bold">Địa chỉ rạp</h2>
                                        <p>{dataMap.book?.address}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
